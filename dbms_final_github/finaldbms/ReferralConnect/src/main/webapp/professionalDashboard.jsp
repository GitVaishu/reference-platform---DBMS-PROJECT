...
<head>
    ...
    <title>Professional Dashboard | Referral Connect</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-banner">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h3>Welcome back, <%= professional.getName() %>!</h3>
                    <p>"Thank you for empowering students with your valuable recommendations."</p>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="professionalProfile.jsp" class="btn btn-custom">Edit Profile</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Check your requests</p>
                        <a href="viewReceivedRequests.jsp" class="btn btn-custom">View Requests</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Permanently remove your profile</p>
                        <form action="${pageContext.request.contextPath}/DeleteProfessionalProfileServlet"
                              method="post"
